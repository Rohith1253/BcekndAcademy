...
import { User as UserIcon, ArrowRight, LogOut, LayoutDashboard, UserCheck, Trophy, BarChart3, Terminal } from "lucide-react";
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {open && (
        <div
          role="menu"
          className="absolute right-0 mt-2 w-64 rounded-xl border border-slate-200 dark:border-white/10 bg-[var(--surface)] text-[var(--foreground)] shadow-2xl z-50 p-3"
        >
          ...
          <div className="flex flex-col gap-1">
            ...
            >
              <div className="flex items-center gap-2">
                <Trophy className="h-3.5 w-3.5 text-cyan-500 dark:text-cyan-400" />
            ...
            >
              <div className="flex items-center gap-2">
                <BarChart3 className="h-3.5 w-3.5 text-cyan-500 dark:text-cyan-400" />
            ...
            >
              <div className="flex items-center gap-2">
                <Terminal className="h-3.5 w-3.5 text-cyan-500 dark:text-cyan-400" />
          ...
          <button
            ...
            className="flex w-full items-center gap-2 rounded-lg px-2.5 py-2 text-xs font-medium text-rose-600 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-500/10 transition-colors cursor-pointer"
          >
