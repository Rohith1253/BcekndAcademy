...
export const LEARNER_STAGES: LearnerProfile[] = [
  {
    ...
    description: "Start from absolute scratch with computer hardware, operating systems, memory, and universal logic fundamentals.",
    recommendedCourseSlug: "computer-software-foundations",
    recommendedCourseTitle: "Level 0: How Computers & Software Work",
  ...
  {
    id: "basic-js",
    title: "Know Basic Syntax",
    subtitle: "Know variables and basic functions",
    description: "Deep dive into algorithmic thinking, data structures, asynchronous JavaScript, and server runtimes.",
    recommendedCourseSlug: "javascript-foundations",
    recommendedCourseTitle: "Level 2: JavaScript Foundations",
  ...
  },
  {
    ...
    subtitle: "Solid in JavaScript or another language",
    ...
    recommendedCourseTitle: "Level 5: Backend Development with Node.js",
    recommendedLevel: "Level 5",
    icon: "Server",
    color: "indigo"
  },
  {
    ...
    subtitle: "Ready to build scalable systems",
    description: "Tackle distributed architectures, caching with Redis, message queues, Docker, and microservices.",
    recommendedCourseSlug: "system-architecture-microservices",
    recommendedCourseTitle: "Level 9: System Architecture & Microservices",
    recommendedLevel: "Level 9",
    icon: "Database",
    color: "purple"
  }
];
