...
export const FIVE_COURSES: CatalogCourse[] = [
  {
    ...
    category: "Node.js",
    language: "javascript",
    frameworks: ["Node.js", "Express", "HTTP", "REST"],
    learningPath: "backend-javascript",
    difficulty: "beginner",
    ...
    prerequisites: ["async-javascript"],
    whyItMatters: "Node.js is the foundation for server-side JavaScript execution.",
    published: true,
    order: 1,
    executionSupport: "interactive",
  },
  {
    ...
    prerequisites: ["backend-node-js"],
    whyItMatters: "Type safety prevents production bugs before deployment.",
    published: true,
    order: 2,
    executionSupport: "interactive",
  },
  {
    ...
    category: "Express",
    language: "javascript",
    frameworks: ["Express", "REST APIs", "Middleware"],
    learningPath: "backend-javascript",
    difficulty: "intermediate",
    level: "Level 5: Intermediate",
    levelNumber: 6,
    ...
    whyItMatters: "REST APIs power client-server communication worldwide.",
    published: true,
    order: 3,
    executionSupport: "interactive",
  },
  {
    ...
    whyItMatters: "Data persistence and indexing are central to backend architecture.",
    published: true,
    order: 4,
    executionSupport: "interactive",
  },
  {
    ...
    category: "Security",
    language: "javascript",
    frameworks: ["JWT", "Bcrypt", "Security"],
    learningPath: "backend-javascript",
    difficulty: "intermediate",
    ...
    whyItMatters: "Securing APIs and authentication safeguards user data.",
    published: true,
    order: 5,
    executionSupport: "interactive",
  },
